"""
性能审查员优化测试 #05：汇总 —— 串联 01-04 结果

无 LLM 调用，纯数据汇总。

用法：python tests/optimization/performance_reviewer/opt_perf_05_aggregate.py
"""
import sys
import subprocess
import time
...
SCRIPTS = [
    ("01-smoke",       "opt_perf_01_smoke.py"),
    ("02-detect",      "opt_perf_02_detect.py"),
    ("03-noise",       "opt_perf_03_noise.py"),
    ("04-severity",    "opt_perf_04_severity.py"),
]
