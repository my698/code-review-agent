"""
B01 验证脚本 #05：干净代码样本 — 无明显问题，验证 coder 是否跳过 minor 问题

代码本身可运行、风格合规、无严重缺陷。验证 coder 的"跳过规则"是否生效，
不应为 LOW/MEDIUM 级别问题过度修复。

用法：python tests/bugfix/b01/test_b01_05_clean.py
"""
import sys
import asyncio
import ast
...
# 干净代码样本：功能正确、有 docstring、异常处理得当
SAMPLE_CODE = '''
...
if __name__ == "__main__":
    ...
    config = {"configurable": {"thread_id": "b01-test-005"}}
